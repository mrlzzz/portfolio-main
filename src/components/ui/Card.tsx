...
const Card = ({ data }: CardProps) => {
  ...
  return (
    <div className="relative mx-2 mb-20 flex h-fit flex-col justify-between gap-10 border border-gray-600 bg-gray-800 last:mb-6 hover:brightness-105 active:shadow-none lg:mx-6 lg:mb-6">
