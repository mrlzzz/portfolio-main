  ...
  return (
    <Section>
      <>
        ...
        <div className="mx-auto flex h-[75vh] max-w-7xl flex-col  gap-10 divide-y divide-red-400 border border-gray-600 p-4 lg:flex-row lg:divide-x lg:divide-y-0">
          <div className="flex flex-col items-center justify-center gap-4 lg:w-[40%] ">
